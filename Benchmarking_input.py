...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 60, 161, 171))
...
"border-color: rgb(170, 0, 0);")
        ...
        MainWindow.setTabOrder(self.runButton, self.refresh)
        MainWindow.setTabOrder(self.refresh, self.radioButton_1)
        ...
        MainWindow.setTabOrder(self.lineEdit_4, self.saveButton)
        MainWindow.setTabOrder(self.saveButton, self.horizontalSlider)
        MainWindow.setTabOrder(self.horizontalSlider, self.horizontalSlider_2)
        MainWindow.setTabOrder(self.horizontalSlider_2, self.writeCheckBox)
        MainWindow.setTabOrder(self.writeCheckBox, self.readCheckBox)
        MainWindow.setTabOrder(self.readCheckBox, self.comboBox)
        MainWindow.setTabOrder(self.comboBox, self.log)
